...
export const INITIAL_GOALS: import('../types').GoalItem[] = [
  {
    id: 'goal-bike',
    childId: 'luca',
    ...
    parentMatchMax: 50,
    totalMatchedSoFar: 35.0,
  },
  {
    id: 'goal-ps5',
    childId: 'luca',
    title: 'PlayStation Game Bundle',
    category: 'Gaming & Digital',
    icon: 'sports_esports',
    currentAmount: 20.0,
    targetAmount: 80.0,
    targetDate: '30 Aug 2024',
    status: 'needs_attention',
    statusLabel: 'Needs Attention',
    weeklyNeeded: 7.5,
    allowanceDeductionPercent: 0,
    allowanceDeductionAmount: 0,
    parentMatchEnabled: false,
    parentMatchPercent: 25,
    parentMatchMax: 40,
    totalMatchedSoFar: 0,
  },
  {
    id: 'goal-lego-archived',
    childId: 'luca',
    ...
    currentAmount: 50.0,
    targetAmount: 50.0,
    targetDate: '10 Apr 2024',
    status: 'completed',
    statusLabel: 'Archived',
    parentMatchEnabled: true,
    parentMatchPercent: 50,
    parentMatchMax: 25,
    totalMatchedSoFar: 25.0,
    isArchived: true,
  },
];

export const INITIAL_FAMILY_NOTIFICATIONS: import('../types').FamilyNotificationItem[] = [
  {
    id: 'notif-1',
    type: 'limit_warning',
    childName: 'Luca',
    childAge: 12,
    childId: 'luca',
    title: 'Limit Warning: Luca approaching daily cap',
    time: '14:28',
    day: 'today',
    description:
  ...
  },
  {
    ...
    childAge: 12,
    childId: 'luca',
    title: 'Money Request from Luca: €8.50',
    time: '12:15',
    day: 'today',
    description:
    ...
    isRead: false,
    metadata: {
      note: 'Art project sketch pad and drawing pencils 🎨',
  ...
  },
  {
    ...
    childAge: 12,
    childId: 'luca',
    title: 'Card Declined: Luca at Online Gaming',
    time: '10:04',
    day: 'today',
    description:
      'Transaction of €19.99 declined. Reason: Online gaming category is currently restricted in Luca\'s family controls.',
    amount: 19.99,
    isRead: false,
    metadata: {
      reason: 'Online gaming category restricted',
      securityRule: 'Security Rule Triggered',
    },
  },
  {
    id: 'notif-4',
    ...
    childAge: 12,
    childId: 'luca',
    title: 'Goal Milestone! 70% Funded',
    time: '18:30',
    day: 'yesterday',
    description:
      'Luca\'s \'New Mountain Bike\' vault reached €175.00! Parent match added +€12.50.',
    amount: 175.0,
    isRead: true,
    metadata: {
      target: 250.0,
      goalTitle: 'New Mountain Bike',
      matchAdded: 12.5,
    },
  },
  {
    ...
    childAge: 9,
    childId: 'sofia',
    title: 'Task Completed: Clean Bedroom & Desk',
    time: '16:45',
    day: 'yesterday',
    description:
      'Sofia completed her weekly chore. Photo verification submitted. Reward: €4.00.',
    amount: 4.0,
    isRead: true,
    metadata: {
      taskTitle: 'Clean Bedroom & Desk',
      habitType: 'Weekly Habit',
      photoFile: 'bedroom_tidy_proof.jpg',
      photoTime: '16:42',
    },
  },
  {
    ...
    isRead: true,
    metadata: {
      store: 'School Cafeteria',
      paymentMethod: 'Contactless Debit',
      newBalance: 45.1,
    },
  },
];
